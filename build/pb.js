(function (global, factory) {
  ...
  var StandardMenuItem = function StandardMenuItem(props) {
    var Compo = props.href ? 'a' : 'button';
    var Comp = props.Comp || Compo;
    return React__default.createElement("div", {
  ...
  function (_Component2) {
    ...
    _createClass(OptionsList, [{
      ...
      value: function render() {
        ...
        }), this.state.dropdown.length > 0 && React__default.createElement(OptionsListDropdown, {
