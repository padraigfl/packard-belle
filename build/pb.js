(function (global, factory) {
  ...
  (factory((global.PackardBelle = {}),global.React,global.PropTypes,global.classnames,global.clone,global.RSelect));
}(this, (function (exports,React,PropTypes,classnames,clone,RSelect) { 'use strict';

  var React__default = 'default' in React ? React['default'] : React;
  PropTypes = PropTypes && PropTypes.hasOwnProperty('default') ? PropTypes['default'] : PropTypes;
  classnames = classnames && classnames.hasOwnProperty('default') ? classnames['default'] : classnames;
  clone = clone && clone.hasOwnProperty('default') ? clone['default'] : clone;
  RSelect = RSelect && RSelect.hasOwnProperty('default') ? RSelect['default'] : RSelect;
  ...
  var Select = function (_Component) {
    ...
    createClass(Select, [{
      ...
      value: function render() {
        ...
        return React__default.createElement(RSelect, _extends({}, props, {
          className: 'Select',
