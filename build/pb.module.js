...
var StaticWindow = function StaticWindow(props) {
  return React.createElement(
    ...
    React.createElement(
      ...
      props.onHelp && React.createElement(NavButton, { className: 'window__help', onClick: props.onHelp }),
      (props.onMaximize || props.onMinimize) && React.createElement(NavButton, { className: 'window__minimize', onClick: props.onMinimize }),
      props.isMaximized && props.onRestore && React.createElement(NavButton, { className: 'window__restore', onClick: props.onRestore }),
      !props.isMaximized && props.onMaximize && React.createElement(NavButton, { className: 'window__maximize', onClick: props.onMaximize }),
      props.onClose && React.createElement(NavButton, { className: 'window__close', onClick: props.onClose })
    ),
    props.children
  );
};
