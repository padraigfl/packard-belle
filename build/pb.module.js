...
var Theme = function Theme(props) {
  return React.createElement(
    'div',
    { className: 'w98', style: props.style },
    props.children
  );
};
...
var css$a = ".standard-menu__wrapper {\n  visibility: hidden;\n  z-index: 10; }\n\n.active + .standard-menu__wrapper {\n  visibility: visible; }\n";
styleInject(css$a);
  ...
  return _temp2 = _class = function (_Component) {
    ...
    function StandardMenuSimple() {
      ...
      return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = StandardMenuSimple.__proto__ || Object.getPrototypeOf(StandardMenuSimple)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        _this.setState(_extends({}, changes, { isOpen: !_this.state.isOpen }));
        return false;
      }, _this.rightButtonClick = function (e) {
        var changes = {
          options: _this.props.options,
          posX: e.pageX,
          posY: e.pageY
        };
        var menuEl = _this.el.getElementsByClassName('standard-menu__wrapper')[0];
        if (_this.state.isOpen) {
          document.body.removeEventListener('click', function (e) {
            return _this.handleBlur(e, menuEl);
          });
        } else {
        ...
        var el = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _this.el;
...
var ExplorerView = function ExplorerView(props) {
  return React.createElement(
    ...
    props.options && props.options.map(function (option) {
      return React.createElement(Bleh, _extends({
        key: option.title
      }, option));
    })
  );
...
ExplorerView.propTypes = {
  options: PropTypes.arrayOf(PropTypes.shape(Bleh.propTypes)),
